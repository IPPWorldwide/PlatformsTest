...
class IPP {
    ...
    public function login($username,$password) {
        ...
        $login_response = $this->request->curl($_ENV["API_URL"]."/company/login/", "POST", [], $data);
    ...
    public function CheckLogin() {
        ...
        return $this->request->curl($_ENV["API_URL"]."/company/data/", "POST", [], $data);
    }
    ...
    public function TransactionsData($action_id) {
        ...
        return $this->request->curl($_ENV["API_URL"]."/company/payments/", "POST", [], $data)->content;
    }
    public function TransactionsRelated($transaction_id) {
        ...
        return $this->request->curl($_ENV["API_URL"]."/company/payments/related/", "POST", [], $data)->content;
    }
    public function TransactionsAction($action,$transaction_id,$action_id,$amount = 0) {
        ...
        return $this->request->curl($_ENV["API_URL"]."/company/payments/$action/", "POST", [], $data);
    }

    public function Charts() {
        $data = ["user_id" => $this->user_id, "session_id" => $this->session_id];
        return $this->request->curl($_ENV["API_URL"]."/company/charts/", "POST", [], $data)->content;
    }


    public function MerchantData($data = []) {
        $data = ["user_id" => $this->user_id, "session_id" => $this->session_id];
        return $this->request->curl($_ENV["API_URL"]."/company/data/", "POST", [], $data)->content;
    }
    public function MerchantDataUpdate($all_data = []) {
        ...
        $this->request->curl($_ENV["API_URL"]."/company/data/update", "POST", [], $security_data);
        ...
        return $this->request->curl($_ENV["API_URL"]."/company/data/update.php", "POST", [], $meta_data)->content;
    }
    public function MerchantAcquirerUpdate($acquirer_id,$settings = []) {
        $data = ["user_id" => $this->user_id, "session_id" => $this->session_id];
        $data["acquirer_id"] = $acquirer_id;
        $data["settings"] = $settings;
        return $this->request->curl($_ENV["API_URL"]."/company/acquirer/data/update.php", "POST", [], $data)->content;
    }
    ...
    public function SendPaymentLink($sender,$recipient,$expiry_time,$order_id,$amount,$currency) {
        ...
        return $this->request->curl($_ENV["API_URL"]."/company/payments/links/create/", "POST", [], $data);
    }

    public function InvoiceData($invoice_id) {
        $data = ["user_id" => $this->user_id, "session_id" => $this->session_id,"id" => $invoice_id];
        return $this->request->curl($_ENV["API_URL"]."/company/invoice/", "POST", [], $data)->content;
    }

    public function AddUser($all_data = []) {
        $data = ["user_id" => $this->user_id, "session_id" => $this->session_id];
        $data = array_merge($all_data, $data);
        return $this->request->curl($_ENV["API_URL"]."/company/users/add/", "POST", [], $data);
    }
    public function CloseUser($update_user_id) {
        ...
        return $this->request->curl($_ENV["API_URL"]."/company/users/close/", "POST", [], $data);
    }
    public function ResetUserPassword($update_user_id,$password) {
        ...
        return $this->request->curl($_ENV["API_URL"]."/company/users/password/reset/", "POST", [], $data);
    }
    public function UserData($merchant_id) {
        $data = ["user_id" => $this->user_id, "session_id" => $this->session_id,"company_id" => $merchant_id];
        return $this->request->curl($_ENV["API_URL"]."/company/users/data/", "POST", [], $data)->content;
    }
    public function RequestResetUserPassword($partner_id,$email, $portal) {
        $data = ["partner_id" => $partner_id,"email" => $email,"portal" => $portal];
        return $this->request->curl($_ENV["API_URL"]."/company/users/password/request/", "POST", [], $data);
    }
    public function ConfirmResetUserPassword($partner_id,$user_id,$initialization_time,$hash) {
        ...
        return $this->request->curl($_ENV["API_URL"]."/company/users/password/request/confirm.php", "POST", [], $data);
    }

    public function DisputesData($dispute_id) {
        $data = ["dispute_id" => $dispute_id,"user_id" => $this->user_id, "session_id" => $this->session_id];
        return $this->request->curl($_ENV["API_URL"]."/company/payments/disputes/data/", "POST", [], $data)->content;
    }
    public function DisputesUpload($dispute_id,$type,$file) {
        ...
        return $this->request->curl($_ENV["API_URL"]."/company/payments/disputes/upload/", "POST", [], $data, [],$file)->content;
    }
    public function DisputesRelated($transaction_id) {
        $data = ["transaction_id" => $transaction_id,"user_id" => $this->user_id, "session_id" => $this->session_id];
        return $this->request->curl($_ENV["API_URL"]."/company/payments/disputes/related/", "POST", [], $data)->content;
    }

    public function Search($search_term) {
        $data = ["user_id" => $this->user_id, "session_id" => $this->session_id,"search" => $search_term];
        return $this->request->curl($_ENV["API_URL"]."/company/search/", "POST", [], $data)->content;
    }


    public function ListPayouts() {
        $data = ["user_id" => $this->user_id, "session_id" => $this->session_id];
        return $this->request->curl($_ENV["API_URL"]."/company/payouts/list/", "POST", [], $data)->content;
    }
    public function ListDisputes($state = "ALL", $status = "ALL") {
        ...
        return $this->request->curl($_ENV["API_URL"]."/company/payments/disputes/list/", "POST", [], $data)->content;
    }
    public function ListUsers() {
        $data = ["user_id" => $this->user_id, "session_id" => $this->session_id];
        return $this->request->curl($_ENV["API_URL"]."/company/users/list/", "POST", [], $data)->content;
    }
    public function ListInvoices() {
        $data = ["user_id" => $this->user_id, "session_id" => $this->session_id];
        return $this->request->curl($_ENV["API_URL"]."/company/invoice/list/", "POST", [], $data)->content;
    }
    public function ListPaymentLinks() {
        $data = ["user_id" => $this->user_id, "session_id" => $this->session_id];
        return $this->request->curl($_ENV["API_URL"]."/company/payments/links/list/", "POST", [], $data)->content;
    }
    ...
    {
        $data = ["user_id" => $this->user_id, "session_id" => $this->session_id];
        return $this->request->curl($_ENV["API_URL"]."/company/users/access_policy/list/", "GET", $data);
    }
